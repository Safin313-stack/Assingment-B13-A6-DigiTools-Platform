const plans = [
  {
    ...
    features: ["10 free tools", "Community support", "Basic analytics", "1 user"],
    cta: "Get Started",
    highlight: false,
  },
  {
    ...
    features: ["200+ tools", "Priority support", "Advanced analytics", "5 users", "API access"],
  ...
  },
  {
    ...
    features: ["Unlimited tools", "Dedicated support", "Custom integrations", "Unlimited users", "SLA guarantee"],
    cta: "Contact Sales",
    highlight: false,
  },
];
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid md:grid-cols-3 gap-6 items-center">
        {plans.map((plan, i) => (
          <div
            key={i}
            className={`rounded-2xl p-7 flex flex-col gap-5 relative transition-all ${
              plan.highlight
                ? 'text-white scale-105 shadow-2xl'
                : 'bg-white border border-gray-200 hover:border-[#4F39F6]/30 hover:shadow-md'
            }`}
            style={plan.highlight ? {background: 'linear-gradient(135deg, #4F39F6 0%, #7C3AED 100%)'} : {}}
          >
            {plan.highlight && (
