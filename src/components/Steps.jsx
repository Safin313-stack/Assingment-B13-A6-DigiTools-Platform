...
const steps = [
  {
    ...
    description: "Sign up for free in seconds and get instant access to our full marketplace of digital tools.",
    img: userImg,
  },
  {
    title: "Choose Products",
    description: "Browse 500+ premium tools, compare features and pricing, then add your picks to cart.",
    img: packageImg,
  },
  {
    title: "Start Creating",
    description: "Get immediate access after purchase and start supercharging your digital workflow today.",
    img: rocketImg,
  },
];
  ...
  <section id="steps" className="py-16 bg-[#F8F9FF]">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        ...
        <p className="text-[#627382] text-sm max-w-md mx-auto">
          Simple, fast, and effective. Join thousands of professionals today.
        </p>
      </div>
